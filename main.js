...
// const emailForSpam = customers.customers.map((currentObject) => {
//     for (let key in currentObject){
//         if (key === "contacts"){
//            for (let emailKey in currentObject[key]) {
//                if (emailKey === "email"){
//                     // currentObject[key][emailKey].forEach((emailAddr)=>{
//                         for (let i =0; i < currentObject[key][emailKey].length; i++){
//                        return currentObject[key][emailKey]
//                    }
//                    }
//                }
//            }
//         }
//     })
//     console.log(emailForSpam)
let newArray = []
console.log(customers.customers[0].contacts.email)
customers.customers.forEach((person) =>{
    newArray = newArray.concat(person.contacts.email)
})
